...
// `/ar/` is the AR engine; `/vacuum-rogues/` is the game (placeholder until the
// real build is copied in by the deploy workflow).
export const EXTRA_URLS = ['/ar/', '/vacuum-rogues/']
