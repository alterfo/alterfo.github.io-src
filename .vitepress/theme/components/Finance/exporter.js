// File export/import for the encrypted Finance vault. Mirrors Decisions/exporter.js:
...
export function exportEnvelope(envelopeStr, name = 'finance') {
  const date = new Date().toISOString().slice(0, 10)
  const filename = `${name}-${date}.finance`
