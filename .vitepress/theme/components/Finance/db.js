// Encrypted persistence for the Finance vault. Mirrors Decisions/db.js:
...
async function loadEnvelope() {
  ...
  try {
    ...
    console.warn('[finance] loadEnvelope failed:', err)
    return null
  }
}
...
function saveEnvelope(envelopeStr) {
  ...
  _saveTimer = setTimeout(async () => {
    try {
      ...
      console.warn('[finance] saveEnvelope failed:', err)
    }
  }, 300)
}
