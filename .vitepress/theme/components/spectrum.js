...
// turquoise/«бирюза» (#3b7a85) is the 10th sphere — пазлы (/casual-games).
// With 10 spheres the wheel now uses the full CANVAS_PALETTE — no extra colors.
export const SPECTRUM = ['#7a3348', '#a8874a', '#3f5946', '#8a5568', '#4a6178', '#6b5a48', '#2d5654', '#9098a8', '#4a3868', '#3b7a85']
...
export const CANVAS_PALETTE = [
  ...
  'rgba(45,86,84,', 'rgba(144,152,168,', 'rgba(74,56,104,', 'rgba(59,122,133,',
]
...
export const PROJECT_COLORS = {
  ...
  decisions: '#2d5654', music: '#9098a8', finance: '#4a3868', games: '#3b7a85',
}
